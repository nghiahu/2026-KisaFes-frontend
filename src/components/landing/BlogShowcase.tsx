        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div 
              ...
              className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col md:flex-row col-span-1 md:col-span-2 hover:shadow-2xl transition-all duration-300 group cursor-pointer"
            >
              <div className="md:w-3/5 h-64 md:h-auto bg-slate-100 relative overflow-hidden">
            ...
            {blogs.slice(1, 3).map((blog) => (
              <div 
                ...
                className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col cursor-pointer"
              >

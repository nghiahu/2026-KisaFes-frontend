  ...
  if (tasks.length === 0) {
    return (
      <div className="p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-base font-bold text-slate-800 mb-1">No tasks assigned</h3>
      ...
      <div className="space-y-3">
        {tasks.map((task) => (
          <div 
            ...
            className="bg-white border border-slate-200 rounded-xl p-4 flex items-center justify-between cursor-pointer shadow-sm hover:shadow-md hover:border-blue-300 transition-all group"
          >
            <div className="flex items-center gap-4 min-w-0 flex-1">
              {/* Icon/Type */}
              <div className="w-10 h-10 rounded-lg bg-slate-50 flex items-center justify-center text-slate-500 border border-slate-100 shrink-0 group-hover:bg-blue-50 group-hover:text-blue-600 group-hover:border-blue-100 transition-colors">
            ...
            <div className="flex items-center gap-4 shrink-0 pl-4">
              ...
              {task.assigneeId ? (
                ...
                <div className="w-8 h-8 rounded-full border-2 border-dashed border-slate-300 flex items-center justify-center bg-slate-50 text-slate-400" title="Unassigned">
                  <Icons.user size={14} />
                </div>
              )}
            </div>
